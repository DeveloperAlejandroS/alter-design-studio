...
const baseClassName =
  'relative font-serif font-bold tracking-tight uppercase text-[#3a1237]/60 dark:text-[#E8D5D6]/60 hover:text-[#3a1237] dark:hover:text-[#E8D5D6] transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.02] nav-link-elegant after:absolute after:left-0 after:-bottom-1 after:h-px after:w-full after:origin-left after:scale-x-0 after:bg-current after:transition-transform after:duration-300 hover:after:scale-x-100'

const activeClassName =
  'relative font-serif font-bold tracking-tight uppercase text-[#3a1237] dark:text-[#E8D5D6] nav-link-elegant nav-link-active transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.02] after:absolute after:left-0 after:-bottom-1 after:h-px after:w-full after:origin-left after:scale-x-100 after:bg-current after:transition-transform after:duration-300'
