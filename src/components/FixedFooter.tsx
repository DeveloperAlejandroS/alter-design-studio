    ...
    <footer className="bg-[#e9d6d7] dark:bg-[#52284E] border-t border-[#d1c2cb]">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 px-4 sm:px-6 md:px-12 py-14 md:py-20 w-full max-w-screen-2xl mx-auto">
        ...
        <div className="flex flex-col gap-4">
          ...
          <a className="font-serif font-light text-sm tracking-wide text-[#3a1237] dark:text-[#fff8f7] hover:underline decoration-1 underline-offset-4" href="#">Manual Corporativo</a>
          <BrandbookDownloadLink />
          <a className="font-serif font-light text-sm tracking-wide text-[#3a1237] dark:text-[#fff8f7] hover:underline decoration-1 underline-offset-4" href="#">Privacy Policy</a>
          <a className="font-serif font-light text-sm tracking-wide text-[#3a1237] dark:text-[#fff8f7] hover:underline decoration-1 underline-offset-4" href="https://www.instagram.com/alte_rstudio/" target="_blank" rel="noopener noreferrer">Instagram</a>
        </div>
